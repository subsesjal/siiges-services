...
const tipoSolicitudesCSV = path.join(__dirname, '../../../../../core/src/drivers/db/CSVFiles/tipo_solicitudes.csv');
...
const tipoSolicitudes = csvToJsonConvert(tipoSolicitudesCSV);
