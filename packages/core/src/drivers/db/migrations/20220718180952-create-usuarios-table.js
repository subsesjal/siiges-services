...
const { ALUMNOS_GRUPOS_TABLE, AlumnosGruposSchema } = require('../models/alumnosGrupos');
...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.createTable(ALUMNOS_GRUPOS_TABLE, AlumnosGruposSchema);
  },
  ...
  async down(queryInterface) {
    ...
    await queryInterface.dropTable(ALUMNOS_GRUPOS_TABLE);
  },
};
