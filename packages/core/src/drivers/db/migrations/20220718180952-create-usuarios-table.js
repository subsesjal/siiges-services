...
const { ACADEMIAS_TABLE, AcademiasSchema } = require('../models/academias');
...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.createTable(ACADEMIAS_TABLE, AcademiasSchema);
  },
  ...
  async down(queryInterface) {
    ...
    await queryInterface.dropTable(ACADEMIAS_TABLE);
  },
};
