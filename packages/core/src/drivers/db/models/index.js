...
const { AlumnosGrupos, AlumnosGruposSchema } = require('./alumnosGrupos');
...
function setupModels(sequelize) {
  ...
  AlumnosGrupos.init(AlumnosGruposSchema, AlumnosGrupos.config(sequelize));
  ...
  AlumnosGrupos.associate(sequelize.models);
}
