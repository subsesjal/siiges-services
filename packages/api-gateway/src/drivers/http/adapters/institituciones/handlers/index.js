...
const { findInstitucionesByMunicipio } = require('./find-instituciones-by-municipio.adapters');
const { findPlantelesByInstitucionPublic } = require('./find-planteles-by-institucion-public.adapters');
const {
