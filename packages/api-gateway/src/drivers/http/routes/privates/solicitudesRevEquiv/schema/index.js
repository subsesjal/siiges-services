const updateSolicitudRevEquivSchema = require('./update.solicitud-rev-equiv.schema');
const findOneSolicitudRevEquivSchema = require('./find-one.solicitud-rev-equiv.schema');
...
module.exports = {
  ...
  findOneSolicitudRevEquivSchema,
