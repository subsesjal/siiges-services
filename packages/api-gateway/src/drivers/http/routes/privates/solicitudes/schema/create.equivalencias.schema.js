const createEquivalenciaSchema = {
  ...
  properties: {
    ...
    alumnoId: { type: 'string', nullable: true }, // Opcional
    folioExpediente: { type: 'string', nullable: true }, // Opcional
  },
  required: ['tipoTramiteId', 'estatusSolicitud', 'fecha', 'observaciones', 'interesado'],
};
