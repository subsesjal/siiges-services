const {
  ...
  findPlantelInfraestructuraQuery,
...
const findPlantelInfraestructura = require('./find.plantel-infraestructura.use-cases');
...
module.exports = {
  ...
  findPlantelInfraestructura: findPlantelInfraestructura(findPlantelInfraestructuraQuery),
};
