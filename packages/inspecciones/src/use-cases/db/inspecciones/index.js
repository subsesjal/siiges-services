...
const { findAllInspeccionObservaciones } = require('./find-all.inspecciones-observaciones.use-cases');
...
module.exports = {
  ...
  findAllInspeccionObservaciones: findAllInspeccionObservaciones(
    inspecciones.findAllInspeccionObservacionesQuery,
  ),
};
